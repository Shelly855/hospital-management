...
if (isset($_POST['delete'])) {
    ...
    header("Location: ../patient/patient-records.php?deleted=true");
    exit();
}
    ...
    <div class="container">
        ...
        <main>
            ...
            <form method="post">
                ...
                <input type="submit" value="Delete" name="delete"><a href="../patient/patient-records.php" class="back-button">Back</a>
            </form>
        </main>
        <?php
