...
if (isset($_POST['delete'])) {
    ...
    header("Location: ../prescription/prescriptions.php?deleted=true");
    exit();
}
...
<div class="container">
        ...
        <div class="confirm">Are you sure you want to delete this prescription?</div>
        ...
        <form method="post">
            ...
            <input type="submit" value="Delete" name="delete"><a href="../prescription/prescriptions.php" class="back-button">Back</a>
        </form>
        </main>
        <?php
