...
if (isset($_POST['delete'])) {
    ...
    header("Location: ../staffUser/staff-records.php?deleted=true");
    exit();
}
...
<div class="container">
        ...
        <form method="post">
            ...
            <input type="submit" value="Delete" name="delete"><a href="../staffUser/staff-records.php" class="back-button">Back</a>
        </form>
        </main>
        <?php
